...
const TRACKING_MODULE="Pharmacology";
...
function startPractice(bank,title='Practice'){
  ...
  function finish(){
    ...
    document.getElementById('quiz').innerHTML=`<div class="card center">
      ...
      <a class="button primary" href="pharm-dashboard.html">View dashboard</a>
      <a class="button secondary" href="pharm-practice.html">Choose another practice</a>
      <a class="button secondary" href="pharmacology.html">Back to hub</a></div>`;
  }
  load();
}
function startExam(bank,minutes=20){
  ...
  function submitExam(){
    ...
    <a class="button primary" href="pharm-dashboard.html">View dashboard</a></div>
